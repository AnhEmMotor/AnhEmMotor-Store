export const promotionData = [
	{
		id: 1,
		title:
			"Honda Việt Nam tri ân khách hàng với loạt ưu đãi hấp dẫn chào hè...",
		slug: "honda-tri-an-kh-uu-dai-chao-he",
		date: "15/07/2025",
		image:
			"https://cdn.honda.com.vn/news-motorbike/July2025/xQD9vsxGTpqh2umWS1vjvvCsDiMcrgTYmiOqfxDb.webp",
		isHot: true,
		shortDescription:
			"Chương trình khuyến mại khủng dành cho các dòng xe máy và xe gắn máy điện",
		fullTitle:
			"Honda Việt Nam tri ân khách hàng với loạt ưu đãi hấp dẫn chào hè trong chương trình khuyến mại khủng dành cho các dòng xe máy và xe gắn máy điện – Chốt đơn Honda – Săn quà cực đã",
      ...
      <p>Mùa hè là thời điểm lý tưởng để khởi động những hành trình mới, khám phá bản thân và tận hưởng từng khoảnh khắc trên mọi cung đường.</p>
    `,
		benefits: [
			{
				model: "Honda Wave Alpha/ Blade/ Wave RSX",
				options: [
					"01 voucher thẻ điện thoại trị giá 500.000 VNĐ",
					"01 voucher phụ kiện trị giá 600.000 VNĐ",
				],
			},
			{
				model: "Honda Vision",
				options: [
					"02 voucher thẻ điện thoại, mỗi thẻ trị giá 500.000 VNĐ",
					"01 đồng hồ thông minh Samsung Galaxy Fit 3",
			...
			},
			{
				...
				options: [
					"01 điện thoại Samsung Galaxy A06",
					"Gói trả góp lãi suất 0%",
				],
			},
			{
				model: "Honda SH125i/SH160i",
				options: [
					"01 tai nghe Samsung Galaxy",
					"01 voucher phụ kiện trị giá 1.600.000 VNĐ",
				],
			},
			{
				model: "Honda ICON e:",
				options: [
					"01 voucher phụ kiện trị giá 2.000.000 VNĐ",
					"Gói trả góp lãi suất 0%",
				],
			},
		],
		contactInfo: {
			...
			workingHours:
				"Từ 07:30 đến 18:00 tất cả các ngày trong tuần, trừ ngày lễ",
		},
		financialCompanies: [
	...
	},
	{
		id: 2,
		title:
			"Honda Việt Nam triển khai chương trình khuyến mại Chốt xế liền tay,...",
		...
		fullTitle:
			"Honda Việt Nam triển khai chương trình khuyến mại Chốt xế liền tay, quà tặng cực chất",
	...
	},
	{
		...
		date: "05/07/2024",
		image:
			"https://cdn.honda.com.vn/news-motorbike/September2024/vAPKaxLnIWMHzrVpyWdhLaXzZ7RiUT7ooeMOMoIC.webp",
		isHot: false,
		shortDescription: "Thông báo kết thúc chương trình",
		fullTitle:
			"Honda Việt Nam thông báo ngừng nhận đăng ký chương trình Chinh phục mọi cung đường",
		duration: "Kết thúc vào ngày 05/07/2024",
		carouselImages: [],
		content: `<p>Honda Việt Nam xin thông báo kết thúc chương trình khuyến mại.</p>`,
		benefits: [],
	},
	{
		id: 4,
		...
		date: "20/08/2025",
		image:
			"https://yamaha-motor.com.vn/wp/wp-content/uploads/2025/06/d04a4d192a9d8e6f36b63cdcda96c412.webp",
		isHot: false,
		...
		carouselImages: [],
		content: `<p>Ưu đãi đặc biệt dành cho khách hàng trong tháng 8.</p>`,
		benefits: [],
	},
	{
		id: 5,
		...
		date: "10/08/2025",
		image:
			"https://yamaha-motor.com.vn/wp/wp-content/uploads/2024/11/4a28f54f7fd3763a3cf0cc7ca9fefa76-768x432.webp",
		isHot: false,
		shortDescription: "Chương trình khuyến mãi toàn quốc",
		fullTitle: "Khuyến mãi Sắm xe sang - Nhận quà vàng áp dụng toàn quốc",
		duration: "Tháng 08/2025",
		carouselImages: [],
		content: `<p>Chương trình khuyến mãi đặc biệt áp dụng toàn quốc.</p>`,
		benefits: [],
	},
	{
		id: 6,
		...
		date: "01/08/2025",
		image:
			"https://yamaha-motor.com.vn/wp/wp-content/uploads/2024/07/Thumb_1720661013-1-768x432.webp",
		isHot: false,
		shortDescription: "Chiến dịch tiết kiệm xăng",
		fullTitle: "Honda Việt Nam ra mắt chiến dịch Tiết kiệm xăng - Rinh quà lớn",
		duration: "Tháng 08/2025",
		carouselImages: [],
		content: `<p>Chiến dịch khuyến khích tiết kiệm nhiên liệu.</p>`,
		benefits: [],
	},
];
