		...
		return [
			{
				...
				description:
					"Kiểm tra toàn bộ hệ thống xe, từ động cơ đến hệ thống phanh, đảm bảo vận hành êm ái và bền bỉ như mới.",
				price: 150000,
				estimatedTime: "45",
				features: [
			...
			},
			{
				...
				description:
					"Thay thế lốp xe chính hãng Michelin, Dunlop với máy ra vào lốp hiện đại, không làm trầy xước vành xe.",
				price: 350000,
				estimatedTime: "30",
				features: [
			...
			},
			{
				...
				description:
					"Chẩn đoán chính xác và khắc phục các sự cố về IC, ắc quy và hệ thống chiếu sáng bằng thiết bị đo chuyên dụng.",
				price: 200000,
				estimatedTime: "60",
				features: [
			...
			},
			{
				...
				description:
					"Phục hồi công suất động cơ, xử lý triệt để các tiếng động lạ và tình trạng hao xăng, mang lại sức mạnh nguyên bản.",
				price: 500000,
				estimatedTime: "120",
				features: [
			...
			},
			{
				...
				description:
					"Hỗ trợ khách hàng hoàn thiện thủ tục đăng kiểm, sang tên và các vấn đề pháp lý nhanh chóng, đúng quy định.",
				price: 300000,
				estimatedTime: "90",
				features: [
