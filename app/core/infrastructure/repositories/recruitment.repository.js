    ...
    return [
      {
        ...
        content:
          'Có, AnhEm Motor luôn sẵn sàng đào tạo bài bản cho các ứng viên chưa có kinh nghiệm nhưng có thái độ tốt và đam mê học hỏi, đặc biệt là ở vị trí Tư vấn bán hàng và CSKH.',
      },
      {
        label: 'Mức lương và chế độ đãi ngộ như thế nào?',
        content:
          'Chúng tôi cung cấp mức lương cạnh tranh kèm theo hoa hồng doanh số hấp dẫn. Ngoài ra, nhân viên còn được hưởng các chế độ như thưởng lễ Tết, du lịch hàng năm và BHXH theo quy định.',
      },
      {
        label: 'Mất bao lâu để nhận được phản hồi sau khi ứng tuyển?',
        content:
          'Thông thường bộ phận nhân sự sẽ liên hệ với bạn trong vòng 24h - 48h làm việc kể từ khi nhận được hồ sơ ứng tuyển trực tuyến.',
      },
      {
        label: 'Có yêu cầu bằng cấp chuyên môn cho vị trí kỹ thuật viên không?',
        content:
          'Đối với kỹ thuật viên sửa chữa, chúng tôi ưu tiên các ứng viên có chứng chỉ nghề hoặc bằng cấp liên quan. Tuy nhiên, tay nghề thực tế và kinh nghiệm vẫn là yếu tố quyết định quan trọng nhất.',
      },
    ];
  },
