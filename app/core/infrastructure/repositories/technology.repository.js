    ...
    return [
      {
        ...
        description:
          "Trải nghiệm không gian trưng bày ảo, xoay 360 độ để khám phá mọi chi tiết thiết kế tinh xảo của các dòng xe mới nhất.",
        image:
          "https://images.unsplash.com/photo-1591637333184-19aa84b3e01f?q=80&w=600",
        icon: "ph:cube-fill",
      },
      {
        title: "AI Health Monitor",
        description:
          'Hệ thống AI sử dụng học máy để phân tích tiếng động cơ và dữ liệu cảm biến, đưa ra cảnh báo "sức khỏe" xe theo thời gian thực.',
        image:
          "https://images.unsplash.com/photo-1580519542036-c47de6196ba5?q=80&w=600",
        icon: "ph:heartbeat-fill",
      },
      {
        title: "Chuyên gia ảo AI",
        description:
          "Tư vấn kỹ thuật 24/7. Nhập tình trạng xe, AI sẽ chẩn đoán lỗi và gợi ý giải pháp khắc phục hoặc đặt lịch sửa chữa tức thì.",
        image:
