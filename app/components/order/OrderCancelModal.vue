    ...
    >
      <div class="p-8 text-center">
        <div class="w-20 h-20 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-6">
          <Icon name="fa6-solid:triangle-exclamation" class="text-3xl text-red-500" />
        </div>
        <h3 class="text-2xl font-black text-gray-900 mb-2 uppercase">Hủy đơn hàng?</h3>
      ...
      <div class="p-8 bg-gray-50 border-t border-gray-100 flex gap-4">
        ...
        <button
          ...
          aria-label="Xác nhận hủy đơn hàng vĩnh viễn"
          @click="emit('confirm')"
        >
          <Icon v-if="isSubmitting" name="fa6-solid:spinner" class="animate-spin" />
          Xác nhận hủy
        </button>
      </div>
    </div>
