    ...
    <div class="space-y-6 sm:space-y-8">
      ...
      >
        <div class="space-y-2 relative z-10">
          <span class="text-[10px] text-white/50 uppercase font-bold tracking-widest"
            >Góp mỗi tháng dự kiến</span
          >
          <div class="text-4xl md:text-5xl font-bold text-primary overflow-hidden my-2">
        ...
        <button
          ...
          @click="sendToZalo"
        >
          <Icon name="ph:whatsapp-logo-fill" class="text-xl" />
          Tư vấn qua Zalo
        </button>

        <p class="text-[10px] text-white/30 font-medium leading-relaxed relative z-10">
          * Giá trị mang tính chất tham khảo, lãi suất thực tế có thể thay đổi tùy ngân hàng và hồ
          sơ khách hàng.
        </p>
      </div>
    </div>
