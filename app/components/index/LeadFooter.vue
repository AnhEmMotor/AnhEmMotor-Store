...
const handleSubmit = () => {
  ...
  setTimeout(() => {
    toast.success('Cảm ơn bạn! AnhEm Motor sẽ liên hệ tư vấn trong 5 phút nữa.');
    leadForm.phone = '';
    leadForm.bike = '';
...
<template>
  <section class="py-20 bg-gray-900 text-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
      ...
      >
        <div class="text-center space-y-6 mb-12">
          <h2 class="text-3xl md:text-5xl lg:text-[42px] font-bold leading-tight tracking-tight">
            Bạn chưa biết chọn
            <span class="text-primary">dòng xe phù hợp?</span>
          </h2>
          <p class="text-slate-400 text-lg font-medium max-w-2xl mx-auto leading-relaxed">
            Ghé cửa hàng để được tư vấn & trải nghiệm thực tế, hoặc để lại thông tin để nhận báo giá
            lăn bánh tốt nhất sau 5 phút.
          </p>
        </div>
        ...
        >
          <LeadFeatureItem icon="ph:lock-key-bold" text="Bảo mật thông tin 100%" />
    ...
    >
      <h1 class="text-[30vw] font-black uppercase text-white whitespace-nowrap">ANH EM MOTOR</h1>
    </div>
  </section>
</template>
