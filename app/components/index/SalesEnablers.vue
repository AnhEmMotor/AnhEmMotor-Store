...
<template>
  <section class="py-12 md:py-24 container mx-auto px-6">
    ...
    >
      <div class="w-full lg:w-[42%] shrink-0">
        <LoanCalculator />
      </div>

      <div
        class="w-full lg:flex-1 text-slate-900 flex flex-col justify-center space-y-10 lg:pl-10 relative z-10"
      >
        <div class="space-y-6 text-left">
          <div
            class="inline-flex items-center px-4 py-2 bg-primary/10 text-primary rounded-full text-xs font-bold uppercase tracking-widest"
          >
            Chương trình đặc biệt
          </div>
          <h2 class="text-4xl md:text-5xl lg:text-[42px] font-bold leading-tight tracking-tight">
            Trả góp <span class="text-primary">0% lãi suất</span> <br class="hidden lg:block" />
            Nhận xe ngay chỉ với CCCD
          </h2>
          <p class="text-slate-500 text-lg font-medium leading-relaxed max-w-xl">
            Hỗ trợ thủ tục trả góp siêu tốc trong 15 phút. Duyệt hồ sơ nhanh chóng, cam kết không
