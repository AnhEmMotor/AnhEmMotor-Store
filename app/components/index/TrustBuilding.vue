...
<template>
	<section class="py-24 bg-white overflow-hidden relative">
		<div class="container mx-auto px-6 relative z-10">
			...
			>
				<div class="flex flex-col gap-4 mb-16 text-center max-w-3xl mx-auto">
					...
					<p class="text-slate-500 font-medium text-lg leading-relaxed">
						Chúng tôi không chỉ cung cấp xe máy, chúng tôi mang đến sự an tâm
						tuyệt đối và dịch vụ tận tâm trên từng chặng đường.
					</p>
				</div>
				<div
			...
			<div
				class="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start mb-24"
			>
				<div class="space-y-10 lg:col-span-5">
					<div class="space-y-6">
						...
						<p class="text-slate-500 font-medium text-lg">
							Mời bạn ghé thăm showroom của chúng tôi để trải nghiệm trực tiếp
							các mẫu xe mới nhất.
						</p>
					</div>
					...
					>
						<div class="flex items-center gap-6">
							...
							<div>
								<div
									class="text-[11px] text-gray-400 font-black uppercase tracking-widest mb-1"
								>
									Địa chỉ Showroom
								</div>
						...
						<div
							class="flex items-center gap-6 border-y border-gray-200/50 py-8"
						>
							<div
								class="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center shrink-0"
							>
				...
				<div class="lg:col-span-7">
					...
					>
						...
						>
							...
							<div
								class="flex items-center gap-5 border-y border-gray-100 py-6"
							>
								<div
									class="w-12 h-12 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center shrink-0"
								>
