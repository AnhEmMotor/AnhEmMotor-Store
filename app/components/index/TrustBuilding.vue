...
<template>
  <section class="py-24 bg-white overflow-hidden relative">
    <div class="container mx-auto px-6 relative z-10">
      <div class="bg-slate-50 rounded-24 p-6 sm:p-10 md:p-16 mb-24 border border-slate-100">
        <div class="flex flex-col gap-4 mb-16 text-center max-w-3xl mx-auto">
          <div class="text-primary font-bold uppercase tracking-widest text-sm">
            Giá trị cốt lõi
          </div>
          ...
          <p class="text-slate-500 font-medium text-lg leading-relaxed">
            Chúng tôi không chỉ cung cấp xe máy, chúng tôi mang đến sự an tâm tuyệt đối và dịch vụ
            tận tâm trên từng chặng đường.
          </p>
        </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start mb-24">
        <div class="space-y-10 lg:col-span-5">
          ...
          <div
            class="hidden lg:flex flex-col bg-slate-50 p-10 rounded-[40px] border border-slate-100 shadow-soft space-y-8"
          >
            <div class="flex items-center gap-6">
              <div
                class="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center shrink-0"
              >
                <Icon name="ph:map-pin-bold" class="text-3xl" />
              </div>
              <div>
                <div class="text-[11px] text-gray-400 font-black uppercase tracking-widest mb-1">
                  Địa chỉ Showroom
                </div>
                <div class="text-gray-900 font-black text-lg leading-tight">
                  {{ SHOWROOMS[0].address }}
                </div>
              </div>
            </div>
            ...
            <div class="flex items-center gap-6 border-y border-gray-200/50 py-8">
              ...
              <div>
                ...
                <div class="text-gray-900 font-black text-xl leading-none">
                  {{ SHOWROOMS[0].phone }}
                </div>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-6">
                ...
                <div>
                  ...
                  <div class="text-gray-900 font-black text-base leading-none">
              ...
              <div class="flex flex-col items-end">
                <span
                  class="text-[9px] font-black text-green-500 uppercase tracking-widest mb-1 animate-pulse"
                  >● Đang mở cửa</span
                >
              </div>
            </div>
        ...
        <div class="lg:col-span-7">
          <div
            class="relative w-full h-[450px] lg:h-[600px] rounded-[32px] lg:rounded-[50px] overflow-hidden shadow-elevated group bg-white"
          >
            ...
            <div
              ...
              :class="[isInfoOpen ? 'flex flex-col translate-y-0 opacity-100' : 'hidden']"
            >
              <button
              ...
              <div class="flex items-center gap-5">
                ...
                <div>
                  <div class="text-[10px] text-gray-400 font-black uppercase tracking-widest mb-1">
                    Địa chỉ Showroom
                  </div>
                  <div class="text-gray-900 font-black text-sm leading-tight">
                    {{ SHOWROOMS[0].address }}
                  </div>
                </div>
              </div>
              ...
              <div class="flex items-center gap-5 border-y border-gray-100 py-6">
                ...
                <div>
                  ...
                  <div class="text-gray-900 font-black text-lg leading-none">
                    {{ SHOWROOMS[0].phone }}
                  </div>
                </div>
              </div>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <div class="text-gray-900 font-black text-sm leading-none">
                      08:00 - 20:00 (Hàng ngày)
                    </div>
                  </div>
                </div>
      ...
      <div class="mt-24 pt-20 border-t border-slate-100/80">
        <div class="space-y-4 text-center max-w-3xl mx-auto mb-16">
          ...
          <div class="flex justify-center gap-1">
            <Icon v-for="i in 5" :key="i" name="ph:star-fill" class="text-xl text-yellow-400" />
          </div>
        </div>
