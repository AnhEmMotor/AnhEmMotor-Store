    ...
    >
      <div class="space-y-4 max-w-2xl">
        ...
        <p class="text-slate-500 text-lg font-medium">
          Cập nhật những xu hướng, kinh nghiệm xe máy mới nhất từ các chuyên
          gia.
        </p>
      </div>
        ...
        >
          <div class="relative z-10 space-y-4">
            ...
            <p class="text-white/60 text-base leading-relaxed">
              Theo dõi kênh Youtube của AnhEm Motor để không bỏ lỡ những bản tin
              đánh giá xe mới nhất.
            </p>
          </div>
