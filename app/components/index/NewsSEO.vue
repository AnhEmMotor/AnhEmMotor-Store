  ...
  <section class="py-24 container mx-auto px-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
      ...
      <div class="lg:col-span-4">
        <div
          class="h-full p-8 bg-slate-900 rounded-24 text-white space-y-8 relative overflow-hidden flex flex-col justify-between"
        >
          <div class="relative z-10 space-y-4">
            ...
            <h3 class="text-2xl md:text-3xl font-bold leading-tight">
              Đánh giá xe thực tế cùng chuyên gia
            </h3>
            <p class="text-white/60 text-base leading-relaxed">
              Theo dõi kênh Youtube của AnhEm Motor để không bỏ lỡ những bản tin đánh giá xe mới
              nhất.
            </p>
          </div>
