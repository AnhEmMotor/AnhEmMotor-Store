<template>
	<section
		id="listings"
		class="listings-section py-16 md:py-24 max-w-7xl mx-auto"
	>
		<div class="container mx-auto px-4 sm:px-6 md:px-8">
			<div class="section-header text-center mb-8 sm:mb-12">
				...
				<p class="text-base text-gray-600 max-w-xl mx-auto">
					Khám phá những mẫu xe máy hot nhất hiện nay với giá cả cạnh tranh và
					chất lượng đảm bảo
				</p>
			</div>

			<div
				id="motorcycleListings"
			...
			>
				...
				>
					<div class="inline-block bg-white p-8 rounded-lg shadow-md">
						<i class="fas fa-search text-4xl text-red-400 mb-4" />
						<p class="text-xl text-gray-600 italic">
							Không tìm thấy xe máy nào phù hợp.
						</p>
					</div>
				</div>
				...
				>
					...
					<div class="card-content p-6 flex flex-col flex-grow">
						...
						>
							<i class="fas fa-eye" /> Xem chi tiết
						</button>
					</div>
				</div>
			</div>
	...
	>
		...
		>
			...
			<div class="grid md:grid-cols-2 gap-0">
				<div
					class="modal-image-wrapper rounded-t-lg md:rounded-l-lg md:rounded-t-none"
				>
					<img
				...
				<div class="modal-text-content p-6 sm:p-8 flex flex-col">
					...
					<p
						class="modal-price text-2xl sm:text-3xl font-bold text-red-600 mb-4 sm:mb-6"
					>
						{{ formatCurrency(selectedMotorcycle.price) }}
					</p>

					<div
						class="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-700"
					>
					...
					<p
						class="modal-description mt-4 sm:mt-6 text-sm sm:text-base text-gray-700 flex-grow"
					>
					...
					<div class="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
						...
						>
							<i class="fas fa-phone mr-2" /> Liên hệ tư vấn
						</button>
						<button
						...
						>
							<i class="fas fa-shopping-cart mr-2" /> Đặt xe ngay
						</button>
					</div>
				</div>
			</div>
...
const motorcycles = ref([
	...
	},
	{
		...
		image: "/assets/image/index/newest-product/vstrom.webp",
	},
	{
		id: 4,
		brand: "Kawasaki",
	...
	},
	{
		...
		image: "/assets/image/index/newest-product/neos.webp",
	},
]);
