    ...
    <div class="container mx-auto px-6">
      <div class="flex flex-col md:flex-row justify-between items-end gap-10 mb-16">
        <div class="space-y-4 max-w-2xl">
          ...
          <h2
            class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 leading-tight"
          >
            Video <span class="text-primary">Review</span>
          </h2>
          <p class="text-slate-500 text-lg font-medium">
            Cái nhìn thực tế nhất về những mẫu xe đang "làm mưa làm gió" trên thị trường qua những
            thước phim ngắn.
          </p>
        </div>
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        <ReelCard v-for="reel in REELS" :key="reel.id" :reel="reel" @play="openVideo" />
      </div>
    </div>

    <VideoModal :is-open="isOpen" :video-url="activeVideo" @close="closeVideo" />
  </section>
</template>
