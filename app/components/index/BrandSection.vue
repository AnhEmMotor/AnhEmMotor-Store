  ...
  <div class="brands-section overflow-hidden relative">
    ...
    <div class="container mx-auto px-6">
      <div class="section-header">
        ...
        <p class="description">
          AnhEm Motor tự hào là đối tác phân phối các dòng xe máy chính hãng từ những thương hiệu
          hàng đầu.
        </p>
      </div>
    </div>
    ...
    <div class="marquee-wrapper">
      <div class="marquee-content group">
        <div v-for="(brand, index) in manualBrands" :key="`brand-${index}`" class="brand-card">
          <div class="brand-inner">
            <img :src="brand.img" :alt="brand.alt" class="brand-logo" loading="lazy" />
