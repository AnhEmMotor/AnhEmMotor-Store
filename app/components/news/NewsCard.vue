...
<template>
	...
	>
		...
		<div class="p-6">
			...
			<h3
				class="text-xl font-bold text-dark-text mt-2 mb-3 leading-snug group-hover:text-primary-red transition-colors duration-300"
			>
				{{ news.title }}
			</h3>
			...
			<span
				class="text-primary-red font-bold mt-4 inline-block text-sm hover:underline"
			>
