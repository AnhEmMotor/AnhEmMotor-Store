...
defineProps({
  ...
  subtitle: {
    type: String,
    default:
      'Cập nhật tin tức mới nhất về xe máy, sự kiện showroom và cẩm nang công nghệ từ AnhEm Motor.',
  },
  backgroundImage: {
    type: String,
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="hidden lg:block relative group animate-fade-in-right">
          ...
          >
            ...
            >
              <span class="text-[9px] font-black uppercase text-center leading-none mb-1"
                >Showroom</span
              >
              <span class="text-base font-black uppercase leading-none">HOT</span>
            </div>
