    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      >
        ...
        <div class="space-y-3">
          ...
          <p class="text-[13px] text-gray-500 font-medium leading-relaxed px-2 line-clamp-2">
            {{ cat.desc }}
          </p>
        </div>
        ...
        <div class="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div class="lg:col-span-7 space-y-6">
            <div class="flex items-center gap-4">
              ...
              <h3 class="text-2xl font-extrabold text-gray-900 uppercase tracking-tight">
            ...
            <div class="flex flex-wrap gap-4 pt-4">
              ...
              >
                ...
                <span class="text-[11px] font-extrabold text-gray-700 uppercase tracking-wider">{{
                  feature
                }}</span>
              </div>
            </div>
          ...
          <div class="lg:col-span-5">
            ...
            >
              <div class="space-y-2">
                <p class="text-[10px] font-extrabold text-gray-400 uppercase tracking-[0.2em]">
                  Hành động tiếp theo
                </p>
                <p class="text-lg font-extrabold text-gray-900 uppercase leading-tight">
