<template>
	<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
		<div class="text-center mb-12 space-y-3">
			...
			<p class="text-4xl font-extrabold text-gray-900 uppercase tracking-tight">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
			...
			>
				...
				<div class="space-y-3">
					...
					<p
						class="text-[13px] text-gray-500 font-medium leading-relaxed px-2 line-clamp-2"
					>
						{{ cat.desc }}
					</p>
				</div>
				...
				<div class="pt-2">
					<div
						class="inline-flex items-center gap-2 transition-all duration-500"
					>
						<span
		...
		<transition name="panel">
			<div
				v-if="activeIdx !== -1"
				class="mt-12 bg-gray-50 rounded-3xl p-10 border border-gray-100 relative overflow-hidden"
			>
				<div
					class="absolute top-0 right-0 w-64 h-64 bg-red-600/5 rounded-full -translate-y-1/2 translate-x-1/2"
				/>
				...
				>
					<div class="lg:col-span-7 space-y-6">
						<div class="flex items-center gap-4">
							<div
								class="w-12 h-12 bg-red-600 text-white rounded-xl flex items-center justify-center shadow-lg shadow-red-600/20"
							>
						...
						<div class="flex flex-wrap gap-4 pt-4">
							<div
								v-for="feature in categories[activeIdx].features"
								:key="feature"
								class="flex items-center gap-2 px-4 py-2 bg-white rounded-lg border border-gray-100 shadow-sm"
							>
								<Icon
								...
								/>
								<span
									class="text-[11px] font-extrabold text-gray-700 uppercase tracking-wider"
									>{{ feature }}</span
								>
							</div>
						</div>
					...
					<div class="lg:col-span-5">
						<div
							class="bg-white p-8 rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 space-y-6"
						>
							<div class="space-y-2">
								<p
									class="text-[10px] font-extrabold text-gray-400 uppercase tracking-[0.2em]"
								>
									Hành động tiếp theo
								</p>
								<p
									class="text-lg font-extrabold text-gray-900 uppercase leading-tight"
								>
									{{ categories[activeIdx].ctaDesc }}
								</p>
							</div>
							<button
...
const categories = [
	{
		...
		cta: "Tìm hiểu ngay",
		detail:
			"AnhEm Motor hỗ trợ trả góp qua nhiều ngân hàng và công ty tài chính với lãi suất cực thấp. Thủ tục chỉ cần CCCD gắn chip, xét duyệt hồ sơ trong vòng 15-30 phút.",
		features: [
			"Hỗ trợ trả trước 0đ",
			"Lãi suất 0%",
			"Thủ tục CCCD",
	...
	},
	{
		...
		cta: "Đặt lịch ngay",
		detail:
			"Đội ngũ kỹ thuật viên tay nghề cao sẽ giúp xế yêu của bạn luôn trong tình trạng hoàn hảo nhất. Chúng tôi sử dụng 100% phụ tùng chính hãng.",
		features: [
			"Kỹ thuật viên 5 sao",
			"Phụ tùng chính hãng",
			"Vệ sinh xe miễn phí",
	...
	},
	{
		...
		cta: "Nhận hỗ trợ",
		detail:
			"Nếu bạn có bất kỳ thắc mắc nào về cách vận hành, các thông số kỹ thuật hoặc các hiện tượng lạ của xe, hãy liên hệ ngay với chúng tôi.",
		features: [
			"Tư vấn 24/7",
			"Kỹ thuật chuyên sâu",
			"Hướng dẫn sử dụng",
	...
	},
	{
		...
		cta: "Gửi phản hồi",
		detail:
			"Sự hài lòng của quý khách là ưu tiên hàng đầu của chúng tôi. Mọi ý kiến đóng góp sẽ được ban quản trị xem xét và phản hồi trong 24h.",
		features: [
			"Lắng nghe 100%",
			"Xử lý triệt để",
			"Bảo mật thông tin",
