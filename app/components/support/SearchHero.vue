	...
	<section class="relative pt-16 pb-20 overflow-hidden bg-gray-900">
		...
		>
			<div class="space-y-6 max-w-3xl mx-auto">
				<div class="space-y-3">
					<div
						class="inline-flex items-center gap-2.5 px-3 py-1.5 bg-black/40 backdrop-blur-md rounded-full border border-white/10 mb-2"
					>
						<span class="w-1 h-1 bg-red-600 rounded-full animate-pulse" />
						<span
							class="text-[9px] font-extrabold uppercase tracking-[0.3em] text-white"
				...
				<div class="relative group max-w-xl mx-auto pt-2">
					...
					/>
					<div
						class="relative flex items-center bg-white rounded-xl overflow-hidden shadow-2xl"
					>
				...
				<div class="flex flex-wrap justify-center gap-4 pt-1">
					<span
						class="text-[9px] font-extrabold text-white/50 uppercase tracking-widest drop-shadow-sm"
						>Từ khóa:</span
					>
					<a
						v-for="tag in ['Trả góp', 'Bảng giá xe', 'Địa chỉ', 'Bảo dưỡng']"
						:key="tag"
						href="#"
