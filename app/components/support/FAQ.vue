    ...
    <div class="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-12 space-y-6">
        <div class="relative max-w-2xl mx-auto">
          <Icon
            ...
            class="absolute left-6 top-1/2 -translate-y-1/2 text-gray-400 text-sm"
          />
          <input
            v-model="searchQuery"
            type="text"
      ...
      <div class="space-y-3">
        ...
        >
          ...
          >
            <span
              class="text-[14px] font-extrabold text-gray-900 uppercase tracking-tight group-hover:text-red-600 transition-colors leading-tight"
              >{{ faq.question }}</span
            >
            <div
          ...
          <div v-show="activeIdx === idx" class="px-8 pb-8 animate-fade-in">
        ...
        >
          ...
          <p class="text-[11px] font-extrabold text-gray-400 uppercase tracking-widest">
...
const faqs = [
  {
    ...
    answer:
      'Tất cả các dòng xe mua tại hệ thống AnhEm Motor đều được bảo hành chính hãng theo quy định của nhà sản xuất (Honda, Yamaha, Suzuki...). Quý khách chỉ cần mang xe và sổ bảo hành đến chi nhánh để được kiểm tra miễn phí.',
  },
  {
    category: 'Trả góp',
    question: 'Mua xe trả góp cần chuẩn bị những giấy tờ gì?',
    answer:
      'Hiện tại thủ tục trả góp rất đơn giản, bạn chỉ cần Căn cước công dân gắn chíp. Thời gian duyệt hồ sơ chỉ từ 15-30 phút, hỗ trợ trả trước từ 0đ tùy theo dòng xe và đơn vị tài chính.',
  },
  {
    category: 'Giấy tờ',
    question: 'Thời gian hoàn tất thủ tục biển số là bao lâu?',
    answer:
      'Thông thường thời gian chờ biển số sẽ từ 7-15 ngày làm việc tùy thuộc vào địa phương đăng ký hộ khẩu của khách hàng. Chúng tôi có đội ngũ hỗ trợ trọn gói thủ tục này.',
  },
  {
    category: 'Hỗ trợ',
    question: 'Có hỗ trợ tư vấn kỹ thuật tận nơi khi gặp sự cố không?',
    answer:
      'Hiện tại chúng tôi hỗ trợ tư vấn kỹ thuật qua Hotline và tại cửa hàng. Đối với các trường hợp xe gặp sự cố nặng, chúng tôi khuyến khích khách hàng đưa xe đến trung tâm bảo dưỡng gần nhất để được kiểm tra chính xác nhất.',
  },
  {
    category: 'Bảo dưỡng',
    question: 'Bao lâu thì tôi nên thay nhớt và bảo dưỡng định kỳ?',
    answer:
      'Theo khuyến cáo, bạn nên thay nhớt sau mỗi 1,500km - 2,000km và bảo dưỡng tổng quát sau mỗi 6,000km để xe luôn vận hành ổn định và bền bỉ.',
  },
];
...
const filteredFaqs = computed(() => {
  return faqs.filter((faq) => {
    ...
    const matchesCategory =
      activeCategory.value === 'Tất cả' || faq.category === activeCategory.value;
