			...
			>
				<div class="flex flex-col lg:flex-row gap-12">
					...
					<div class="w-full lg:w-1/2 flex flex-col">
						<div class="mb-6">
							<span
								class="inline-block px-3 py-1 bg-red-50 text-[#de0000] text-xs font-bold rounded-full uppercase tracking-widest mb-4"
							>
								{{ product.type }}
							</span>
							<h1
						...
						<div class="space-y-8 flex-grow">
							<div class="pt-6 border-t border-gray-100">
								...
								<p class="text-gray-600 leading-relaxed text-lg">
									{{
										product.description ||
										"Thông tin chi tiết đang được cập nhật cho sản phẩm này."
									}}
								</p>
							</div>
