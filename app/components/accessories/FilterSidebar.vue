<template>
	<aside class="flex-shrink-0 mb-8 z-[41] h-full flex flex-col bg-white">
		<div
			class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 h-full overflow-y-auto"
		>
			...
			<div class="mb-6">
				...
				<div class="flex flex-wrap gap-2">
					<button
						...
						:class="
							modelValue.color === 'all'
								? 'border-[#de0000] shadow-[0_0_0_2px_rgba(222,0,0,0.1)]'
								: 'border-gray-300'
						"
						title="Tất cả màu"
					...
					>
						<i
							v-if="modelValue.color === 'all'"
							class="fas fa-check text-xs text-[#de0000]"
						/>
...
const props = defineProps({
	...
	modelValue: {
		type: Object,
		default: () => ({ productType: "all", priceRange: "all", color: "all" }),
	},
});
