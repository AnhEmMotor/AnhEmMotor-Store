  ...
  <div class="lg:w-1/3 xl:w-1/4 flex flex-col gap-5 lg:sticky lg:top-24 lg:h-max">
    ...
    >
      ...
      >
        ...
        >
          <Icon name="fa6-solid:spinner" class="animate-spin text-red-600 text-3xl" />
        </div>
      </div>
      ...
      <p class="text-gray-500 text-sm mt-1 text-center w-full truncate px-2" :title="user?.email">
      ...
      <nav class="flex flex-col">
        ...
        >
          <div
            :class="[
              ...
              modelValue === 'profile' ? 'bg-primary/10 text-primary' : 'bg-gray-100 text-gray-500',
            ]"
          >
        ...
        >
          <div
            :class="[
              'w-8 h-8 rounded-md flex items-center justify-center transition-colors',
              modelValue === 'orders' ? 'bg-primary/10 text-primary' : 'bg-gray-100 text-gray-500',
            ]"
          >
