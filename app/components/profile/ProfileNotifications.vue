	...
	promotions: [
		{
			...
			date: "2024-05-12",
			content:
				"Chương trình áp dụng cho tất cả các dòng xe tay ga và xe số tại toàn hệ thống...",
			isRead: false,
		},
	],
	vouchers: [
...
<template>
	<div
		class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden animate-fadeIn"
	>
