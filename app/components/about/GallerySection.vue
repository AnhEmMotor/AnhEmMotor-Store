  ...
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-6">
      <div class="text-center mb-16">
        <h2
          class="text-3xl md:text-5xl font-[800] text-gray-900 mb-6 uppercase tracking-tight"
        >
          Không Gian Trải Nghiệm
        </h2>
        <p class="text-xl text-gray-500 max-w-2xl mx-auto">
          Hệ thống showroom và khu vực kỹ thuật hiện đại, nơi đam mê tốc độ được
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          ...
          >
            ...
            >
              <h3 class="text-white text-xl font-black mb-2 uppercase">
                Showroom Hiện Đại
              </h3>
              <p
          ...
          >
            ...
            >
              ...
              <p
                class="text-gray-300 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              >
                Đội ngũ tư vấn và kỹ thuật viên nhiệt huyết, luôn sẵn sàng hỗ
                trợ khách hàng.
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <p
                class="text-gray-300 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              >
                Trang thiết bị tiên tiến cùng quy trình bảo dưỡng đạt chuẩn
                chính hãng.
              </p>
            </div>
          </div>
