    ...
    <div class="max-w-7xl mx-auto px-6">
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-500 max-w-2xl mx-auto">
          Hệ thống showroom và khu vực kỹ thuật hiện đại, nơi đam mê tốc độ được phục vụ chuyên
          nghiệp.
        </p>
      </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <p
                class="text-gray-300 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              >
                Không gian trưng bày đẳng cấp với đầy đủ các dòng xe mới nhất.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              <p
                class="text-gray-300 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              >
                Đội ngũ tư vấn và kỹ thuật viên nhiệt huyết, luôn sẵn sàng hỗ trợ khách hàng.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              <p
                class="text-gray-300 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              >
                Trang thiết bị tiên tiến cùng quy trình bảo dưỡng đạt chuẩn chính hãng.
              </p>
            </div>
          </div>
        </div>
