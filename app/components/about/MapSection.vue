<template>
	<section class="bg-white py-10 sm:py-16 px-4 sm:px-6 md:px-8 mb-6 sm:mb-10">
		<div class="max-w-7xl mx-auto">
			<h2 class="text-3xl md:text-4xl text-center mb-4 font-bold text-red-500">
				Bản Đồ Các Cơ Sở
			</h2>
			<p class="text-center text-lg text-gray-500 mb-8 sm:mb-10">
				Tìm cơ sở AnhEm Moto gần bạn nhất
			</p>

			<div
				class="rounded-2xl overflow-hidden shadow-xl h-[300px] sm:h-[400px] md:h-[500px] relative mb-8"
			>
				<iframe
					id="mapFrame"
			...
			<div class="mt-8 bg-white p-4 sm:p-5 rounded-xl shadow-lg">
				<h3 class="text-red-500 mb-5 text-center font-bold text-xl sm:text-2xl">
					🗺️ Các Cơ Sở Trên Bản Đồ
				</h3>
					...
					>
						<div class="flex items-center">
							...
							<div class="location-details">
								<strong class="block mb-1 text-base sm:text-lg">{{
									loc.title
								}}</strong>
								<small class="text-gray-600 text-sm sm:text-base">{{
									loc.address
								}}</small>
							</div>
						</div>
