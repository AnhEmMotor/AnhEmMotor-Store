<template>
  <div class="py-20 text-center">
    ...
    <h2 class="text-2xl font-black text-gray-900 mb-2">Giỏ hàng của bạn đang trống</h2>
    <p class="text-gray-500 mb-8">Vui lòng thêm sản phẩm vào giỏ hàng trước khi thanh toán.</p>
    <NuxtLink
      to="/products"
