    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
      ...
      <div class="space-y-4 mb-6">
        <div class="flex justify-between text-sm">
          <span class="text-gray-500">Tạm tính ({{ cartItems.length }} sản phẩm)</span>
          <span class="font-medium text-gray-900">{{ formatPrice(summary.subtotal) }}</span>
        </div>
        <div class="flex justify-between text-sm">
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="text-right">
            ...
            <p class="text-[10px] text-gray-400 mt-0.5">(Đã bao gồm VAT nếu có)</p>
          </div>
        </div>
      </div>
      ...
      >
        <div class="flex items-center justify-center gap-2 relative z-10">
          <Icon v-if="isLoading" name="fa6-solid:spinner" class="animate-spin" />
          <Icon
            v-else
