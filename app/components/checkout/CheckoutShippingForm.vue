...
<template>
  ...
  <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div class="space-y-2">
        <label class="text-xs font-black text-gray-400 uppercase tracking-widest">Họ và tên</label>
        <input
      ...
      <div class="space-y-2">
        ...
        <div class="relative">
          <select
            ...
            :class="{
              '!border-red-500 !bg-red-50': orderStore.errors.provinceId,
        ...
        <p
          v-if="orderStore.errors.provinceId"
          class="text-[10px] text-red-500 font-bold mt-1 ml-1 uppercase tracking-tighter"
        >
          {{ orderStore.errors.provinceId }}
        </p>
      </div>
      ...
      <div class="space-y-2">
        ...
        <div class="relative">
          <select
            ...
            style="font-family: 'Manrope', sans-serif"
            :class="{
              '!border-red-500 !bg-red-50': orderStore.errors.wardCode,
          ...
          >
            <option value="" disabled>
              {{ isLoadingWards ? 'Đang tải...' : 'Chọn Quận/Huyện/Phường/Xã' }}
            </option>
        ...
        <p
          v-if="orderStore.errors.wardCode"
          class="text-[10px] text-red-500 font-bold mt-1 ml-1 uppercase tracking-tighter"
        >
          {{ orderStore.errors.wardCode }}
        </p>
      </div>
    </div>
      ...
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="space-y-2">
            ...
            />
            <p
              v-if="orderStore.errors.companyName"
              class="text-[10px] text-red-500 font-bold mt-1 ml-1 uppercase tracking-tighter"
            >
              {{ orderStore.errors.companyName }}
            </p>
          </div>
          ...
          <div class="space-y-2">
            ...
            />
            <p
              v-if="orderStore.errors.companyTaxCode"
              class="text-[10px] text-red-500 font-bold mt-1 ml-1 uppercase tracking-tighter"
            >
              {{ orderStore.errors.companyTaxCode }}
            </p>
          </div>
          ...
          <div class="md:col-span-2 space-y-2">
            ...
            />
            <p
              v-if="orderStore.errors.companyAddress"
              class="text-[10px] text-red-500 font-bold mt-1 ml-1 uppercase tracking-tighter"
            >
              {{ orderStore.errors.companyAddress }}
            </p>
          </div>

          <div class="space-y-2">
            <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest"
              >Email nhận hóa đơn (tùy chọn)</label
            >
            <input
            ...
            />
            <p
              v-if="orderStore.errors.companyEmail"
              class="text-[10px] text-red-500 font-bold mt-1 ml-1 uppercase tracking-tighter"
            >
              {{ orderStore.errors.companyEmail }}
            </p>
          </div>

          <div class="space-y-2">
            <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest"
              >Mã đơn vị ngân sách (tùy chọn)</label
            >
            <input
            ...
            />
            <p
              v-if="orderStore.errors.budgetCode"
              class="text-[10px] text-red-500 font-bold mt-1 ml-1 uppercase tracking-tighter"
            >
              {{ orderStore.errors.budgetCode }}
            </p>
          </div>
        </div>
      </div>
