...
<template>
  ...
  >
    ...
    <p class="text-base text-slate-500 leading-relaxed font-medium">"{{ testimonial.comment }}"</p>

    <div
      class="absolute -top-4 -left-4 w-10 h-10 bg-primary text-white rounded-full flex items-center justify-center shadow-lg shadow-primary/20"
    >
