<template>
	<div class="contact-form p-6 sm:p-10">
		<div class="mb-10">
			<div
				class="inline-flex items-center gap-2 px-3 py-1 bg-primary/10 rounded-full mb-4"
			>
				<Icon
					name="ph:envelope-simple-open-fill"
					class="text-primary text-sm"
				/>
				<span
					class="text-[10px] font-bold uppercase tracking-wider text-primary"
					>Liên hệ trực tuyến</span
				>
			</div>
			<h3 class="text-2xl sm:text-3xl font-black mb-3 text-gray-900">
				Gửi yêu cầu hỗ trợ
			</h3>
			<p class="text-gray-500 text-sm font-medium leading-relaxed max-w-md">
				Vui lòng để lại thông tin, đội ngũ chăm sóc khách hàng của chúng tôi sẽ
				liên hệ với bạn trong vòng 24h làm việc.
			</p>
		</div>
		...
		<form class="space-y-6" @submit.prevent="handleSubmit">
			...
			>
				...
				<Icon
					...
					class="text-lg group-hover:rotate-12 transition-transform"
				/>
