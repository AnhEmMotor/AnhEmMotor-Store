  ...
  <div class="contact-form p-6 sm:p-10">
    <div class="mb-10">
      ...
      <p class="text-gray-500 text-sm font-medium leading-relaxed max-w-md">
        Vui lòng để lại thông tin, đội ngũ chăm sóc khách hàng của chúng tôi sẽ liên hệ với bạn
    ...
    <form class="space-y-6" @submit.prevent="handleSubmit">
      ...
      <Transition name="fade">
        ...
        >
          <Icon
            :name="statusType === 'success' ? 'ph:check-circle-fill' : 'ph:warning-circle-fill'"
            class="text-lg"
          />
          {{ statusMessage }}
        </div>
