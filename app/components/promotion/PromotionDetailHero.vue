...
<template>
  <section
    class="relative min-h-[500px] md:min-h-[650px] flex items-center overflow-hidden bg-gray-950 text-white"
  >
    ...
    <div class="container mx-auto px-6 relative z-10 py-20">
      <div class="max-w-4xl space-y-8">
        <div class="flex flex-wrap items-center gap-4 animate-fade-in">
          ...
          >
            <span
              class="inline-block w-2 h-2 rounded-full bg-current animate-pulse mr-2"
            />
            {{
        ...
        <div class="space-y-4 animate-slide-up">
          <h1
            class="text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight leading-[1.05]"
          >
            {{ promotion.title }}
          </h1>
          <p
        ...
        <div
          class="flex flex-col md:flex-row items-start md:items-center gap-10 pt-6 animate-slide-up delay-200"
        >
          <div
            class="flex items-center gap-6 p-6 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10"
          >
            <div class="text-center min-w-[60px]">
              <span
                class="block text-4xl font-black text-red-500 tabular-nums leading-none"
                >03</span
              >
              <span
                class="text-[9px] font-black text-gray-400 uppercase tracking-widest mt-2 block"
                >Ngày</span
              >
            </div>
            ...
            <div class="text-center min-w-[60px]">
              <span
                class="block text-4xl font-black text-white tabular-nums leading-none"
                >12</span
              >
              <span
                class="text-[9px] font-black text-gray-400 uppercase tracking-widest mt-2 block"
    ...
    <div
      class="absolute bottom-0 right-0 w-1/3 h-full hidden lg:block pointer-events-none"
    >
      <div
        class="absolute inset-0 bg-gradient-to-l from-red-600/20 via-transparent to-transparent"
      />
      <div class="h-full flex items-center justify-end pr-20 opacity-20">
        <Icon
          name="ph:motorcycle-fill"
          class="text-[30rem] -rotate-12 translate-x-20"
        />
      </div>
    </div>
  </section>
