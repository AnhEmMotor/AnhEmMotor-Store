        ...
        >
          ...
          >
            <div class="text-center min-w-[60px]">
              <span class="block text-4xl font-black text-red-500 tabular-nums leading-none"
                >03</span
              >
              <span class="text-[9px] font-black text-gray-400 uppercase tracking-widest mt-2 block"
                >Ngày</span
              >
            </div>
