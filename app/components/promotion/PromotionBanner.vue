...
<template>
  <section
    class="relative min-h-[620px] lg:h-[750px] flex items-center bg-gray-900 overflow-hidden font-['Manrope']"
  >
    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div class="max-w-2xl animate-fade-in-left">
          ...
          >
            <span
              class="w-2.5 h-2.5 bg-red-600 rounded-full animate-pulse shadow-[0_0_15px_rgba(230,0,35,0.8)]"
            />
            <span class="text-[11px] md:text-xs font-black text-red-500 uppercase tracking-[0.25em]"
              >Ưu đãi bùng nổ tháng 08</span
            >
          </div>
          ...
          <p
            class="text-gray-400 text-lg md:text-2xl font-medium max-w-xl mb-12 leading-relaxed border-l-4 border-red-600 pl-8"
          >
            Cơ hội duy nhất trong năm để sở hữu các dòng xe
            <span class="text-white">Honda & Yamaha</span> với mức giá không tưởng.
          </p>
          ...
          <div class="flex flex-wrap gap-4 md:gap-6">
            ...
            >
              ...
              <Icon
                ...
                class="text-lg md:text-xl group-hover:translate-y-1 transition-transform"
              />
            </button>
            <NuxtLink
              to="/support"
