			...
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
				<div class="max-w-2xl animate-fade-in-left">
					...
					>
						...
						/>
						<span
							class="text-[11px] md:text-xs font-black text-red-500 uppercase tracking-[0.25em]"
					...
					>
						...
						<span class="text-white">Honda & Yamaha</span> với mức giá không
						tưởng.
					</p>
				...
				<div class="hidden lg:block relative group animate-fade-in-right">
					...
					>
						...
						>
							<div class="space-y-2">
								<p
									class="text-[10px] font-black text-red-500 uppercase tracking-[0.3em]"
								>
									Spotlight của tuần
								</p>
								<h3
