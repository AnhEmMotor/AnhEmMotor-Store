...
<template>
	<div>
		<div class="hidden lg:block sticky top-32 space-y-6">
			<div
				class="bg-white rounded-[2.5rem] p-10 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden relative"
			>
				...
				<div class="space-y-8">
					<div class="flex items-center justify-between">
						...
						>
						<span
							class="text-[10px] font-black text-red-600 uppercase tracking-widest flex items-center gap-2"
						>
					...
					<div
						class="space-y-1 text-center py-4 bg-gray-50 rounded-2xl border border-gray-100"
					>
						<span
							class="block text-4xl font-black text-gray-950 tracking-tighter"
							>03:12:45</span
						>
						<span
					...
					<div class="space-y-4">
						<div class="flex items-center justify-between text-sm">
							...
							<span class="font-black text-red-600"
								>{{ promotion.remainingSlots || 0 }}/100</span
							>
						</div>
					...
					<div
						class="flex items-center gap-3 p-4 bg-blue-50/50 rounded-xl border border-blue-100"
					>
		...
		<div
			class="lg:hidden fixed bottom-0 left-0 right-0 z-[100] bg-white border-t border-gray-100 p-4 sm:p-6 shadow-[0_-20px_40px_rgba(0,0,0,0.1)] translate-y-0 animate-slide-up-mobile"
		>
				...
				<div class="flex flex-col">
					<div class="flex items-center gap-2">
						...
						<span
							...
							>{{ promotion.remainingSlots || 0 }} suất</span
						>
					</div>
					<div class="text-xl font-black text-gray-950 tracking-tighter">
						03:12:45
					</div>
				</div>
				<button
