...
<template>
  <section
    class="py-12 md:py-20 bg-white relative overflow-hidden font-['Manrope']"
  >
    ...
    <div class="container mx-auto px-4 relative z-10">
      ...
      <div class="grid grid-cols-4 gap-2 md:gap-4 relative">
        ...
        >
          <div
            class="flex flex-col items-center text-center space-y-4 md:space-y-8"
          >
            <div class="relative">
              <div
            ...
            <div class="space-y-1 md:space-y-4">
              ...
              <p
                class="hidden md:block text-gray-500 text-sm font-medium leading-relaxed"
              >
                {{ step.desc }}
              </p>
            </div>
