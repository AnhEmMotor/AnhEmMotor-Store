  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="flex items-center gap-4 flex-1 overflow-x-auto no-scrollbar py-2">
          <div
          ...
          >
            <div class="w-12 h-12 bg-white rounded-xl overflow-hidden shadow-lg p-1">
              <img
                :src="p.image"
            ...
            <div class="space-y-0.5">
              <h4 class="text-[11px] font-black uppercase tracking-tight line-clamp-1">
                {{ p.name }}
              </h4>
          ...
          >
            ...
            <span class="text-[10px] font-black uppercase tracking-widest">Chọn thêm xe...</span>
          </div>
        </div>

        <div class="flex items-center gap-3 border-l border-white/10 pl-6">
          <div class="hidden md:block text-right">
            <p class="text-[10px] text-white/50 uppercase font-black">Sẵn sành so sánh</p>
            <p class="text-xs font-black">{{ compareStore.products.length }}/3 Sản phẩm</p>
          </div>
          <NuxtLink
            to="/compare"
