...
const { data: filterFacetsData } = useQuery({
      ...
      <ClientOnly>
        ...
        <div v-else class="space-y-10">
          ...
          <div v-if="versions.length > 0" class="space-y-4">
            <div class="flex items-center gap-2">
              <div class="w-1 h-4 bg-primary rounded-full" />
              <h3 class="text-sm font-black text-gray-900 uppercase tracking-widest">Phiên Bản</h3>
            </div>
            <div class="relative">
              <select
          ...
          <div v-if="colors.length > 0" class="space-y-4">
            <div class="flex items-center gap-2">
              <div class="w-1 h-4 bg-primary rounded-full" />
              <h3 class="text-sm font-black text-gray-900 uppercase tracking-widest">Màu Sắc</h3>
            </div>
            <div class="grid grid-cols-3 sm:grid-cols-2 gap-2">
              <button
                v-for="col in colors"
