      ...
      >
        ...
        >
          <div class="relative z-10">
            ...
            >
              <Icon
                :name="type === 'TestDrive' ? 'fa6-solid:motorcycle' : 'fa6-solid:calendar-check'"
                class="text-xl text-red-600"
              />
            </div>
            <h2 class="text-3xl font-black uppercase leading-[1.1] tracking-tighter mb-4">
              {{ type === 'TestDrive' ? 'Đăng Ký' : 'Đặt Lịch' }}<br /><span class="text-red-600">{{
                type === 'TestDrive' ? 'Lái Thử' : 'Dịch Vụ'
              }}</span>
            </h2>
        ...
        >
              ...
              <div class="pt-2">
                ...
                >
                  ...
                  >
                    ...
                    {{ type === 'TestDrive' ? 'đăng ký lái thử' : 'đặt lịch dịch vụ' }}
                    tại AnhEm Motor *
                  </span>
                </label>
              </div>
          ...
          >
            ...
            <p class="text-gray-500 font-bold max-w-sm text-xs leading-relaxed">
              Cảm ơn bạn đã tin tưởng AnhEm Motor. Chúng tôi sẽ liên hệ sớm nhất để xác nhận yêu cầu
              của bạn.
            </p>
            <button
