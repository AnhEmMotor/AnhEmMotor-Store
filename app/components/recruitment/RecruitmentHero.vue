  ...
  <section class="relative min-h-screen flex items-center overflow-hidden bg-[#0a0a0a] pt-20">
    ...
    <div class="container mx-auto px-6 relative z-10">
      <div class="max-w-4xl">
        ...
        >
          Chúng tôi không chỉ bán xe, chúng tôi xây dựng những hành trình đầy cảm hứng. Hãy cùng bứt
          phá trong môi trường chuyên nghiệp và đầy cơ hội.
        </p>
        ...
        >
          <div
            ...
            :key="stat.l"
          >
            <div class="text-3xl font-black text-white mb-1 tracking-tighter">
              {{ stat.v }}
            </div>
            <div class="text-white/40 text-[9px] font-black uppercase tracking-widest">
              {{ stat.l }}
            </div>
          </div>
        </div>
