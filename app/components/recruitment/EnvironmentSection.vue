<template>
  <section class="py-20 bg-white relative overflow-hidden">
    <div
      ...
      style="
        background-image: radial-gradient(#de0000 0.5px, transparent 0.5px);
        ...
        <div class="lg:w-1/2 space-y-10">
          <div class="space-y-4">
            ...
            <p class="text-base text-gray-500 font-medium leading-relaxed max-w-lg">
              Tại AnhEm Motor, chúng tôi tin rằng mỗi thành viên là một mảnh ghép quan trọng. Chúng
              tôi xây dựng môi trường làm việc nơi sự trung thực, tinh thần đồng đội và khát vọng
              phát triển luôn được ưu tiên hàng đầu.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div
                class="w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center text-primary mb-6 group-hover:bg-primary group-hover:text-white group-hover:scale-110 transition-all duration-500"
              >
                <Icon :name="item.icon" class="text-2xl" />
              </div>
              <h3 class="text-xl font-black text-gray-900 mb-3 uppercase tracking-tight">
                {{ item.title }}
              </h3>
        ...
        <div class="lg:w-1/2 relative">
          <div class="grid grid-cols-2 gap-6">
            <div class="space-y-6 pt-16">
              ...
              >
                <div class="text-5xl font-black mb-3 tracking-tighter">100%</div>
            ...
            <div class="space-y-6">
              ...
              >
                <div class="text-2xl font-black mb-2 uppercase tracking-tight">Văn hóa Team</div>
                <p class="text-xs font-medium text-white/50 tracking-wide uppercase">
                  Hỗ trợ nhau như gia đình.
                </p>
              </div>
              <div
                class="relative group overflow-hidden rounded-[2.5rem] shadow-2xl shadow-black/10"
          ...
          <div
            class="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-primary/5 rounded-full opacity-50 blur-[120px]"
          />
        </div>
      </div>
    </div>
...
const culture = [
  {
    ...
    desc: 'Luôn đặt lợi ích và trải nghiệm của khách hàng làm kim chỉ nam cho mọi hành động.',
    icon: 'fa6-solid:users',
  },
  {
    title: 'Làm việc minh bạch',
    desc: 'Rõ ràng trong quy trình, trung thực trong mọi giao dịch và cam kết về chất lượng.',
    icon: 'fa6-solid:shield-halved',
  },
  {
    title: 'Hỗ trợ đồng đội',
    desc: 'Sẵn sàng chia sẻ kiến thức và giúp đỡ nhau hoàn thành mục tiêu chung.',
    icon: 'fa6-solid:handshake-angle',
  },
  {
    title: 'Phát triển bền vững',
    desc: 'Cung cấp lộ trình thăng tiến rõ ràng và các khóa đào tạo kỹ năng chuyên sâu.',
