			...
			<div class="flex flex-col lg:flex-row gap-16 items-center">
				<div class="lg:w-1/2 space-y-10">
					<div class="space-y-4">
						...
						>
							Tại AnhEm Motor, chúng tôi tin rằng mỗi thành viên là một mảnh
							ghép quan trọng. Chúng tôi xây dựng môi trường làm việc nơi sự
							trung thực, tinh thần đồng đội và khát vọng phát triển luôn được
							ưu tiên hàng đầu.
						</p>
					</div>
					...
					<div class="grid grid-cols-2 gap-6">
						<div class="space-y-6 pt-16">
							...
							>
								...
								<div
									class="text-xs font-black uppercase tracking-widest opacity-80"
								>
						...
						<div class="space-y-6">
							...
							>
								...
								<p
									class="text-xs font-medium text-white/50 tracking-wide uppercase"
								>
