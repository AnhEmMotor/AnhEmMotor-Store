...
<template>
  <section class="relative min-h-[300px] md:min-h-[400px] flex items-center overflow-hidden w-full">
      ...
      <div class="max-w-2xl text-white space-y-4 md:space-y-6">
        <Transition name="slide-up" mode="out-in">
          <div :key="currentBannerIndex" class="space-y-2">
            <h1
              ...
              class="text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight drop-shadow-xl"
            >
              {{ activeBanner.title }}
            </h1>
          </div>
        ...
        <Transition name="slide-up" mode="out-in">
          <div
            ...
            class="text-sm md:text-base text-white/90 drop-shadow-md font-medium leading-relaxed"
          >
    ...
    <div
      ...
      class="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-1 z-20"
    >
      <button
      ...
      >
        ...
        >
          <div
            ...
            :class="
              index === currentBannerIndex ? 'bg-white/30' : 'bg-white/50 group-hover:bg-white/80'
            "
          />
