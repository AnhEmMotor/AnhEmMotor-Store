  ...
  <div class="w-full">
    ...
    >
      <div class="min-w-0 flex-1">
        <p
          v-if="productName"
          class="text-[9px] font-bold text-gray-400 uppercase tracking-wider truncate"
        >
          {{ productName }}
        </p>
      ...
      <p class="text-[10px] font-black text-primary shrink-0">
        {{ productMapper.formatPrice(price) }}
      </p>
    </button>
