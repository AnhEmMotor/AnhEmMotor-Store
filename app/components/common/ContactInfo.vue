<template>
	<div
		class="bg-yellow-50 border border-yellow-200 rounded-xl p-6 md:p-8 my-8 shadow-md"
	>
		...
		<div class="space-y-4 text-gray-700">
			...
			>
				...
				<div class="overflow-x-auto">
					<table
						class="w-full border-collapse rounded-lg overflow-hidden shadow"
					>
						<thead>
							<tr class="bg-primary-red text-white">
								<th class="p-3 text-left text-sm font-bold">STT</th>
								<th class="p-3 text-left text-sm font-bold">
