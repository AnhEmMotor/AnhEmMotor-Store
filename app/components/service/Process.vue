<template>
	<section
		ref="processRef"
		class="bg-gray-50 py-16 border-y border-gray-100 overflow-hidden relative"
	>
		<div
			class="absolute top-0 right-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2"
		/>
		<div
			class="absolute bottom-0 left-0 w-[300px] h-[300px] bg-primary/5 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2"
		/>
		...
		<div class="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 relative z-10">
			<div class="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
				...
				>
					...
					<div
						class="absolute -top-8 -right-8 w-44 h-44 bg-primary rounded-full flex flex-col items-center justify-center text-white border-[10px] border-gray-50 shadow-2xl group-hover:scale-110 transition-transform duration-500 z-20"
					>
						<span class="text-4xl font-black">10+</span>
						<span
							class="text-[9px] font-black uppercase tracking-widest text-white/80"
				...
				>
					<div class="space-y-6">
						<h2
							class="text-4xl md:text-5xl font-[1000] text-gray-900 leading-[0.9] tracking-tight"
						>
							QUY TRÌNH
							<span
						...
						<p
							class="text-gray-400 text-xs font-black uppercase tracking-[0.4em] flex items-center gap-3"
						>
					...
					<div class="space-y-6">
						...
						>
							<div
								class="flex-shrink-0 w-16 h-16 bg-primary/5 rounded-[1.25rem] flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all duration-500 transform group-hover:rotate-6 shadow-sm"
							>
								<Icon
									:name="step.icon"
									class="text-3xl text-primary group-hover:text-white"
								/>
							</div>
							<div class="space-y-2">
								...
								<p
									class="text-gray-500 text-[13px] font-medium leading-relaxed max-w-lg"
								>
									{{ step.desc }}
								</p>
							</div>
