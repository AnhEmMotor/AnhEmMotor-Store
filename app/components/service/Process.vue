      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
        ...
        >
          ...
          >
            ...
            <span class="text-[9px] font-black uppercase tracking-widest text-white/80"
        ...
        >
          <div class="space-y-6">
            <h2 class="text-4xl md:text-5xl font-[1000] text-gray-900 leading-[0.9] tracking-tight">
              QUY TRÌNH
              <span class="text-primary underline decoration-primary/10 underline-offset-8"
                >TẬN TÂM</span
              >
              <br />
              VÌ AN TOÀN CỦA BẠN
          ...
          <div class="space-y-6">
            ...
            >
              ...
              <div class="space-y-2">
                ...
                <p class="text-gray-500 text-[13px] font-medium leading-relaxed max-w-lg">
                  {{ step.desc }}
                </p>
              </div>
            </div>
