<template>
  ...
  >
    ...
    <div
      class="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 relative z-20 w-full pt-24"
    >
      <div class="max-w-4xl">
        ...
        <div class="space-y-6">
          ...
          >
            Hệ thống trang thiết bị hiện đại bậc nhất cùng đội ngũ chuyên gia
            được đào tạo từ chính hãng. Chúng tôi tận tâm cho sự an toàn của
            bạn.
          </p>
        </div>
        ...
        >
          ...
          <div class="grid grid-cols-3 gap-2 sm:gap-3 w-full sm:w-auto">
            ...
            >
              ...
              />
              <p
                class="text-xl sm:text-2xl font-[1000] leading-none text-white"
              >
                {{ stat.value }}
              </p>
              <p
                class="mt-1.5 text-[8px] font-black uppercase tracking-[0.18em] text-gray-200"
              >
                {{ stat.label }}
              </p>
            </div>
