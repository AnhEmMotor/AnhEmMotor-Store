<template>
	<div class="sticky top-[64px] lg:top-[72px] z-30 bg-white/80 backdrop-blur-xl border-b border-gray-100/50 shadow-[0_4px_20px_-5px_rgba(0,0,0,0.05)]">
		<div class="max-w-7xl mx-auto px-6 lg:px-10">
			<div class="flex items-center gap-2 py-3 overflow-x-auto no-scrollbar relative">
				<button 
					v-for="cat in categories" 
					:key="cat.id"
					@click="$emit('filter', cat.id)"
					:class="[
						'relative px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all duration-500 whitespace-nowrap z-10',
