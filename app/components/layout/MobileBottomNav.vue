<template>
  <div
    class="xl:hidden fixed bottom-0 left-0 right-0 z-[1000] bg-white/80 backdrop-blur-xl border-t border-gray-100 pb-safe shadow-[0_-10px_30px_rgba(0,0,0,0.05)]"
  >
      ...
      >
        <div class="relative">
          <Icon
            ...
            :class="[
              route.path === item.path ? 'text-primary' : 'text-gray-400 group-hover:text-gray-600',
            ]"
          />
          <span
