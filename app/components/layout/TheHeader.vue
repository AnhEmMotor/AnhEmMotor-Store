<template>
  ...
  >
        ...
        <div class="flex items-center gap-6 h-full">
          ...
          >
            ...
            <span
              ...
              :class="isRouteActive(item.path) ? 'w-full' : 'w-0 group-hover/top:w-full'"
            />
          </NuxtLink>
        </div>
      </div>
    ...
    <div
      ...
      :class="[
        isScrolled ? 'py-1.5 sm:py-2 bg-white/90 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)]' : '',
      ]"
    >
      <div
          ...
          <ul class="flex items-center justify-center gap-2 xl:gap-3 2xl:gap-5">
            ...
            <li>
              <NuxtLink
                ...
                >BẢNG GIÁ
                <span class="nav-dot-floating" :class="{ active: isRouteActive('/bang-gia') }"
              /></NuxtLink>
            </li>
            ...
            <li>
              <NuxtLink
                ...
                >KHUYẾN MÃI
                <span class="nav-dot-floating" :class="{ active: isRouteActive('/promotion') }"
              /></NuxtLink>
            </li>
            <li>
              <NuxtLink
                ...
                >DỊCH VỤ
                <span class="nav-dot-floating" :class="{ active: isRouteActive('/service') }"
              /></NuxtLink>
            </li>
            <li>
              <NuxtLink
                ...
                >SO SÁNH XE
                <span class="nav-dot-floating" :class="{ active: isRouteActive('/compare') }"
              /></NuxtLink>
            </li>
            <li>
              <NuxtLink
                ...
                >CÔNG NGHỆ
                <span class="nav-dot-floating" :class="{ active: isRouteActive('/technology') }"
              /></NuxtLink>
            </li>
          </ul>
        </nav>
            ...
            <div v-if="authStore.isLoggedIn" class="flex items-center gap-4">
              ...
              <div class="flex flex-col">
                <NuxtLink
                  ...
                  >Xem hồ sơ</NuxtLink
                >
                <span class="font-black text-gray-950 text-base leading-tight mt-1">{{
                  authStore.user?.fullName || 'Khách hàng'
                }}</span>
              </div>
            </div>
            <div v-else class="flex flex-col leading-[0.85]">
              <span class="text-lg sm:text-xl font-black text-gray-900 uppercase tracking-tighter"
                >ANHEM</span
              >
              <span
...
const isRouteActive = (targetPath) => {
  ...
  if (route.path === '/products') {
    ...
    const isPhuTungPhuKien =
      ...
      (catIdsList.includes(12) && catIdsList.includes(13) && catIdsList.length === 2);
