...
<template>
  ...
  >
    <div
      v-if="isOpen"
      class="fixed inset-0 z-[2000] flex items-center justify-center p-4 lg:p-10"
    >
      <div
      ...
      >
        ...
        >
          <div class="relative z-10">
            <div
              class="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center mb-8 border border-white/10"
            >
              <Icon
                :name="
                  type === 'TestDrive'
            ...
            <div class="mt-8 space-y-4">
              <div
                v-if="variant?.name || product?.name"
                class="p-6 bg-white/5 border border-white/10 rounded-3xl"
              >
                <p
                  class="text-[10px] font-black text-red-600 uppercase tracking-widest mb-1"
                >
              ...
              <div class="space-y-4 pt-4">
                <div class="flex items-center gap-3">
                  ...
                  <span class="text-xs font-bold text-gray-400"
                    >Xác nhận trong 5 phút</span
                  >
                </div>
                <div class="flex items-center gap-3">
                  <Icon name="fa6-solid:circle-check" class="text-red-600" />
                  <span class="text-xs font-bold text-gray-400"
                    >Phục vụ chuyên nghiệp</span
                  >
                </div>
              </div>
            </div>
        ...
        >
          <button
            class="absolute top-8 right-8 w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center text-gray-400 hover:bg-red-600 hover:text-white transition-all shadow-sm"
            @click="close"
          >
          ...
          <div v-if="!isSuccess">
            <div class="mb-10">
              <h3 class="text-2xl font-black text-gray-900 uppercase mb-2">
            ...
            <form class="space-y-6" @submit.prevent="handleSubmit">
              ...
              <div
                ...
                class="space-y-6 pt-4 border-t border-gray-50"
              >
                <div class="mb-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="space-y-2">
                  ...
                  <select
                    ...
                    class="w-full px-4 py-4 bg-gray-50 border-none rounded-2xl text-[10px] font-black focus:ring-2 focus:ring-red-600/20 transition-all uppercase tracking-wider"
                  >
              ...
              <div class="pt-2">
                <label
                  class="flex items-start gap-4 p-5 bg-red-600/5 rounded-3xl border border-red-600/10 cursor-pointer group hover:bg-red-600/10 transition-all"
                >
                  ...
                  <span
                    class="text-[10px] font-bold text-gray-700 uppercase tracking-wider select-none leading-relaxed"
                  >
                    Tôi xác nhận thông tin trên là chính xác và đồng ý
                    {{
                      type === "TestDrive"
                        ? "đăng ký lái thử"
                        : "đặt lịch dịch vụ"
              ...
              <button
                ...
                class="w-full py-5 bg-gray-900 text-white font-black text-xs uppercase tracking-[0.3em] rounded-2xl hover:bg-red-600 transition-all shadow-xl disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center gap-3"
              >
          ...
          <div
            v-else
            class="h-full flex flex-col items-center justify-center text-center space-y-6 py-10"
          >
            <div
              class="w-20 h-20 bg-green-50 text-green-500 rounded-full flex items-center justify-center shadow-lg mb-4"
            >
            ...
            <p class="text-gray-500 font-bold max-w-sm text-xs leading-relaxed">
              Cảm ơn bạn đã tin tưởng AnhEm Motor. Chúng tôi sẽ liên hệ sớm nhất
              để xác nhận yêu cầu của bạn.
            </p>
            <button
              class="px-10 py-4 bg-gray-900 text-white font-black text-[10px] uppercase tracking-[0.3em] rounded-2xl hover:bg-red-600 transition-all shadow-lg"
              @click="close"
            >
              Đóng cửa sổ
            </button>
