...
<template>
  <div class="booking-page min-h-screen bg-[#FDFDFD] py-8 lg:py-12">
    <div class="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      <div
        class="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-red-600/5 rounded-full blur-[120px]"
      />
      <div
        class="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-red-600/5 rounded-full blur-[100px]"
      />
    </div>
      ...
      <div class="max-w-7xl mx-auto">
        <div class="mb-4 animate-reveal-down">
          ...
          <div class="flex items-center gap-3 mt-3">
            ...
            <p
              class="text-gray-400 font-bold text-[8px] uppercase tracking-[0.3em]"
            >
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          <div class="lg:col-span-8 animate-reveal-up pb-6">
            <div
              class="bg-white rounded-[2rem] p-5 lg:p-6 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.04)] border border-gray-100 relative overflow-hidden"
            >
              ...
              <div v-if="!isSuccess">
                <form class="space-y-3" @submit.prevent="handleSubmit">
                  <section class="space-y-3">
                    <div
                      class="flex items-center justify-between pb-2 border-b border-gray-50"
                    >
                      <h2
                        class="text-lg font-black text-gray-900 uppercase tracking-tight flex items-start gap-2 text-left leading-tight"
                      >
                        <span
                          class="text-red-600 text-xl font-black leading-tight shrink-0"
                          >/01</span
                        >
                        <span>Thông tin khách hàng</span>
                      </h2>
                      <Icon
                        name="ph:user-focus-fill"
                  ...
                  <section class="space-y-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div class="space-y-1.5">
                        ...
                        <select
                          ...
                          class="booking-input cursor-pointer"
                        >
                    ...
                    <div class="space-y-1.5">
                      <label
                        class="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1"
                        >Tình trạng xe / Yêu cầu chi tiết *</label
                      >
                      <textarea
                        ...
                        class="booking-input resize-none py-3"
                      />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div class="space-y-1.5">
                        ...
                        <div class="relative">
                          <select
                            v-model="form.hour"
                            class="booking-input cursor-pointer appearance-none"
                          >
                            <option
                          ...
                          <Icon
                            name="ph:clock-fill"
                            class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-300 pointer-events-none"
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="pt-1">
                    <label
                      class="flex items-start gap-3 p-3.5 sm:gap-4 sm:p-4 bg-gray-50 rounded-2xl border border-gray-100 cursor-pointer group hover:bg-white hover:border-red-600/30 transition-all"
                    >
                      <div
                        class="relative flex items-center justify-center mt-0.5 sm:mt-1"
                      >
                        <input
                      ...
                      <span
                        class="text-[10px] sm:text-[11px] font-bold text-gray-500 tracking-normal sm:tracking-wide select-none leading-relaxed"
                      >
                        Tôi xác nhận thông tin trên là chính xác và đồng ý đặt
                        lịch dịch vụ tại AnhEm Motor.
                      </span>
                    </label>
                  </div>
                  ...
                  <button
                    ...
                    class="w-full py-4 bg-gray-950 text-white font-[1000] text-xs uppercase tracking-[0.4em] rounded-[1.25rem] hover:bg-red-600 transition-all shadow-xl disabled:bg-gray-100 disabled:text-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-3 group mt-4"
                  >
                    ...
                    <Icon
                      ...
                      class="text-lg group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform"
                    />
                    <Icon
                      v-else
                  ...
                  <button
                    type="button"
                    class="w-full py-3.5 bg-white border border-gray-100 text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] rounded-[1.25rem] hover:bg-gray-50 hover:text-red-600 hover:border-red-600/30 transition-all mt-2"
                    @click="router.back()"
                  >
                    Hủy bỏ yêu cầu
                  </button>
              ...
              <div v-else class="py-20 text-center space-y-8">
                <div
                  class="w-24 h-24 bg-green-50 text-green-500 rounded-full flex items-center justify-center mx-auto shadow-xl"
                >
                ...
                <div class="space-y-4">
                  ...
                  <p class="text-gray-500 font-medium max-w-sm mx-auto">
                    Cảm ơn bạn đã tin tưởng AnhEm Motor. Đội ngũ chăm sóc khách
                    hàng sẽ liên hệ với bạn trong vòng 5 phút để xác nhận.
                  </p>
                </div>
                <div
                ...
                >
                  <button
                    class="px-10 py-4 bg-gray-900 text-white font-black text-[10px] uppercase tracking-widest rounded-2xl hover:bg-red-600 transition-all shadow-lg"
                    @click="router.push('/')"
                  >
                    Về trang chủ
                  </button>
                  <button
                    class="px-10 py-4 bg-white border border-gray-100 text-gray-900 font-black text-[10px] uppercase tracking-widest rounded-2xl hover:bg-gray-50 transition-all"
          ...
          <div class="lg:col-span-4 animate-reveal-right">
            <div class="sticky top-10 space-y-4">
              <div
                class="bg-[#0D1117] rounded-[2rem] p-8 lg:p-10 text-white relative overflow-hidden shadow-xl border border-white/5"
              >
                <div
                  class="absolute top-0 right-0 w-32 h-32 bg-red-600/10 rounded-full blur-3xl"
                />

                <div class="relative z-10 space-y-8">
                  <div class="flex items-center justify-between">
                    <h2
                      class="text-[8px] font-[1000] uppercase tracking-[0.4em] text-red-600"
                    >
                      Booking Summary
                    </h2>
                    <div
                      class="w-8 h-8 bg-white/5 rounded-xl flex items-center justify-center border border-white/10"
                    >
                      <Icon
                        name="ph:calendar-check-fill"
                  ...
                  <div v-if="service" class="space-y-6">
                    ...
                    <div
                      class="grid grid-cols-2 gap-6 py-6 border-y border-white/5"
                    >
                      <div class="space-y-1">
                        <p
                        ...
                        <p
                          class="text-xl font-[1000] text-red-600 leading-none"
                        >
                          {{
                            service.price
                    ...
                    <div class="space-y-3">
                      ...
                      <div
                        v-for="feat in service.features?.slice(0, 3)"
                        :key="feat"
                      ...
                      >
                        ...
                        />
                        <span
                          class="text-[11px] font-medium text-gray-400 group-hover/item:text-gray-200 transition-colors leading-tight"
                          >{{ feat }}</span
                        >
                      </div>
                    </div>
                  ...
                  <div class="space-y-3 pt-6 border-t border-white/5">
                    ...
                    >
                      <div
                        class="w-8 h-8 bg-red-600/10 rounded-lg flex items-center justify-center"
                      >
                        <Icon
                      ...
                      <div>
                        <p
                          class="text-[9px] font-black uppercase tracking-tight text-white"
                        >
                          Phụ tùng chính hãng
                        </p>
              ...
              <div class="grid grid-cols-1 gap-3">
                <div
                  class="bg-white rounded-2xl p-4 border border-gray-100 flex items-center gap-3 group hover:border-red-600/30 transition-all"
                >
                  <div
                    class="w-10 h-10 bg-red-600/5 rounded-xl flex items-center justify-center group-hover:bg-red-600 transition-all"
                  >
                    <Icon
                      name="ph:phone-call-fill"
                      class="text-lg text-red-600 group-hover:text-white"
                    />
                  </div>
                  <div>
                    <p
                ...
                >
                  <div
                    class="w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center group-hover:bg-gray-900 transition-all"
                  >
                    <Icon
                      name="ph:clock-fill"
                      class="text-lg text-gray-400 group-hover:text-white"
                    />
                  </div>
                  <div>
                    <p
