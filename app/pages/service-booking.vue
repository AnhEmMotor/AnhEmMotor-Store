          ...
          <div class="lg:col-span-8 animate-reveal-up pb-6">
            ...
            >
                ...
                <form class="space-y-3" @submit.prevent="handleSubmit">
                  <section class="space-y-3">
                    <div class="flex items-center justify-between pb-2 border-b border-gray-50">
                      ...
                      >
                        <span class="text-red-600 text-xl font-black leading-tight shrink-0"
                          >/01</span
                        >
                  ...
                  <div class="pt-1">
                    ...
                    >
                      ...
                      >
                        Tôi xác nhận thông tin trên là chính xác và đồng ý đặt lịch dịch vụ tại
                        AnhEm Motor.
                      </span>
                    </label>
                  </div>
              ...
              <div v-else class="py-20 text-center space-y-8">
                ...
                <div class="space-y-4">
                  <h2 class="text-3xl font-black text-gray-900 uppercase">Đăng ký thành công!</h2>
                  <p class="text-gray-500 font-medium max-w-sm mx-auto">
                    Cảm ơn bạn đã tin tưởng AnhEm Motor. Đội ngũ chăm sóc khách hàng sẽ liên hệ với
                    bạn trong vòng 5 phút để xác nhận.
                  </p>
                </div>
              ...
              >
                ...
                <div class="relative z-10 space-y-8">
                  <div class="flex items-center justify-between">
                    <h2 class="text-[8px] font-[1000] uppercase tracking-[0.4em] text-red-600">
                      Booking Summary
                    </h2>
                    <div
                  ...
                  <div v-if="service" class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-6 py-6 border-y border-white/5">
                      <div class="space-y-1">
                        ...
                        <p class="text-xl font-[1000] text-red-600 leading-none">
                          {{
                            service.price
                      ...
                      <div class="space-y-1">
                        ...
                        <p class="text-base font-[1000] text-white leading-tight uppercase">
                          {{
                            form.date
                              ? new Date(form.date).toLocaleDateString('vi-VN')
                              : '17/5/2026'
                          }}<br />
                          <span class="text-[9px] text-red-600 font-bold tracking-widest">{{
                            form.hour || '10:00 AM'
                          }}</span>
                        </p>
                      </div>
                  ...
                  <div class="space-y-3 pt-6 border-t border-white/5">
                    ...
                    >
                      ...
                      <div>
                        <p class="text-[9px] font-black uppercase tracking-tight text-white">
                          Phụ tùng chính hãng
                        </p>
