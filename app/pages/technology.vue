...
const fetchData = async () => {
  try {
    ...
    const [connectivity, engines, safety, cards, management] =
      await Promise.all([
...
<template>
  <div class="tech-page bg-[#0a0a0a] text-white overflow-hidden relative">
    ...
    <section
      class="py-24 px-4 relative overflow-hidden text-center border-t border-white/5 z-10"
    >
      ...
      <div class="relative z-20 max-w-4xl mx-auto reveal reveal-up">
        ...
        <p
          class="text-lg text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed"
        >
          Trải nghiệm dịch vụ di chuyển thông minh và các đặc quyền số độc duy
          nhất chỉ dành cho thành viên của chúng tôi.
        </p>
