...
<template>
  <div
    class="fb-page-container min-h-screen relative overflow-hidden flex flex-col bg-[#FDFDFD]"
  >
    ...
    <div class="container mx-auto px-6 relative z-10 pt-24 pb-12 flex-grow">
      <div class="max-w-3xl mx-auto">
        <div class="text-center mb-6 fb-reveal">
          ...
          <p class="fb-subtitle">
            Bạn muốn AnhEm Motor cải thiện điều gì? Mọi ý kiến của bạn là chìa
            khóa để chúng tôi nâng tầm dịch vụ mỗi ngày.
          </p>
