    ...
    <main class="py-8 md:py-20 bg-gray-50/20 font-['Manrope']">
      <div class="container mx-auto px-4 md:px-8">
        <div v-if="promotionStore.promotions.length > 0" class="space-y-12 md:space-y-20">
          <section
            v-if="activeTab === 'all' && promotionPage === 1 && featuredPromotion"
          ...
          >
            ...
            >
              ...
              <span class="text-[11px] font-black uppercase tracking-[0.2em] text-red-600"
    ...
    <section class="py-16 md:py-24 bg-gray-950 relative overflow-hidden font-['Manrope']">
      ...
      <div class="container mx-auto px-4 relative z-10 text-center space-y-12">
        ...
        <p class="text-gray-400 text-xl md:text-2xl font-medium max-w-3xl mx-auto leading-relaxed">
          Hãy để đội ngũ chuyên gia của AnhEm Motor tư vấn chi tiết nhất về giá lăn bánh và các ưu
          đãi đặc quyền dành riêng cho bạn.
        </p>
