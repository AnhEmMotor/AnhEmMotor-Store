...
watchEffect(() => {
  if (promotion.value) {
    useSeoMeta({
      ...
      description:
        promotion.value.description ?? 'Chi tiết chương trình khuyến mãi từ AnhEm Motor.',
    });
  }
});
  ...
  <div class="bg-gray-50 min-h-screen pt-20 lg:pt-24">
    <main v-if="promotion" class="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
      <div class="bg-white rounded-xl shadow-xl p-6 md:p-10 mb-8 animate-fade-in">
        <p class="text-center text-gray-500 text-sm mb-4">Ngày {{ formatDate(promotion.date) }}</p>
        <h1
        ...
        >
          <p class="font-semibold text-gray-800 flex items-center">
            <Icon name="fa6-regular:calendar-days" class="mr-3 text-yellow-600 text-xl" />
            Thời gian áp dụng:
          ...
          <div class="space-y-6">
            ...
            >
              ...
              <ul class="space-y-2">
                ...
                >
                  <Icon name="fa6-solid:circle-check" class="text-green-500 mr-3 mt-1" />
    ...
    <div v-else class="container mx-auto px-4 py-20 text-center">
      <Icon name="fa6-solid:triangle-exclamation" class="text-6xl text-gray-400 mb-4" />
