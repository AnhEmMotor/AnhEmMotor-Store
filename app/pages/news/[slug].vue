    ...
    <div v-if="news">
            ...
            >
              <div class="flex items-center gap-6 text-xs">
                <div class="flex items-center gap-2">
                  <Icon name="ph:calendar-blank-fill" class="text-red-500 text-base" />
                  <span class="font-black uppercase tracking-wider">{{ news.publishedDate }}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <main class="container mx-auto px-6 mt-4 md:mt-12">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-20">
          <article
            :class="[
              (relatedNews && relatedNews.length > 0) || filteredLatestNews.length > 0
                ? 'lg:col-span-8'
          ...
          >
            ...
            >
              <h3 class="text-xl font-black uppercase tracking-tight text-gray-950">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p v-if="product.colorName" class="text-xs font-medium text-gray-500 mt-1">
            ...
            >
              <div class="space-y-1">
                <h4 class="font-black text-xs uppercase tracking-widest text-gray-400">
                  Chia sẻ bài viết
                </h4>
            ...
            <CommonCommentSection article-type="news" :article-slug="route.params.slug" />
          </article>

          <aside
            v-if="(relatedNews && relatedNews.length > 0) || filteredLatestNews.length > 0"
            class="lg:col-span-4"
          >
            <div class="sticky top-28 space-y-12">
              ...
              />
              <NewsSidebar
                v-if="filteredLatestNews.length > 0"
                title="Tin Mới Nhất"
                :related-news="filteredLatestNews"
              />
            </div>
          </aside>
        </div>
