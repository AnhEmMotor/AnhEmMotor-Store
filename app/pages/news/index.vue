...
<template>
				...
				>
					...
					>
						...
						>
							<!-- Image - 60% Width -->
							<div
								class="lg:w-[60%] relative overflow-hidden aspect-video lg:min-h-[600px]"
							>
								<img
											...
											>
												{{
													featuredNews.createdAt
														? new Date(featuredNews.createdAt)
																.getDate()
																.toString()
																.padStart(2, "0")
	...
	<div class="bg-white min-h-screen font-['Manrope']">
		<CommonBannerCarousel
			v-if="newsStore.banners.length > 0"
			:banners="newsStore.banners"
