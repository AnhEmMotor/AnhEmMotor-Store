  ...
  <div class="bg-white min-h-screen font-['Manrope']">
          ...
          >
            ...
            >
              ...
              <span class="text-[11px] font-black uppercase tracking-[0.2em] text-red-600"
                >Tiêu điểm tin tức trong tuần</span
              >
            </div>
            ...
            >
                  ...
                  <div class="flex items-center gap-4 md:gap-6">
                      ...
                      <span class="block text-xl md:text-3xl font-black text-white leading-none">
                        {{
                          featuredNews.createdAt
                            ? new Date(featuredNews.createdAt).getDate().toString().padStart(2, '0')
                            : new Date().getDate().toString().padStart(2, '0')
                        }}
                      </span>
                      <span
                        class="text-[8px] md:text-[10px] font-black text-white/60 uppercase tracking-widest mt-1 md:mt-2 block"
                        >Ngày</span
                      >
                    </div>
                    ...
                    <div class="text-center">
                      <span class="block text-xl md:text-3xl font-black text-white leading-none">
                        {{
                          featuredNews.createdAt
                            ? (new Date(featuredNews.createdAt).getMonth() + 1)
                                .toString()
                                .padStart(2, '0')
              ...
              >
                <div class="space-y-6 md:space-y-10">
                  ...
                  <h2
                    class="text-3xl md:text-4xl lg:text-5xl font-black text-gray-950 uppercase tracking-tighter leading-[1.1] group-hover:text-red-600 transition-colors"
                  >
                    {{ featuredNews.title }}
                  </h2>
                  ...
                  <div class="pt-8 border-t border-gray-100 flex items-center justify-between">
                    <div class="flex flex-col">
                      <span
                        ...
                        >Category</span
                      >
                      <span class="text-2xl font-black text-red-600 uppercase tracking-tighter">
                        {{ featuredNews.category?.name || featuredNews.category || 'Tin Tức' }}
                      </span>
                    </div>
                    <div
                      class="flex items-center gap-2 md:gap-3 text-gray-950 font-black text-[10px] md:text-xs uppercase tracking-[0.2em] group-hover:translate-x-3 transition-transform duration-500"
                    >
                      Đọc tiếp
          ...
          <section id="news-grid-section" class="space-y-16">
            <div class="flex items-end justify-between border-b border-gray-100 pb-10">
              <div class="space-y-3">
                ...
                <p class="text-gray-400 text-xs font-black uppercase tracking-[0.3em]">
                  Thông tin chính xác, cập nhật nhanh nhất
                </p>
              </div>
              <div
            ...
            <template v-else>
              ...
              >
                ...
                <h3 class="text-2xl font-black text-gray-950 uppercase tracking-tight mb-2">
                  Không tìm thấy bài viết
                </h3>
                <p class="text-gray-400 text-sm max-w-sm mx-auto">
                  Vui lòng quay lại chuyên mục khác hoặc kiểm tra lại sau ít phút.
                </p>
              </div>
    ...
    <section class="py-20 md:py-32 bg-gray-950 relative overflow-hidden">
      ...
      <div class="container mx-auto px-4 relative z-10 text-center space-y-12">
        ...
        >
          Đừng bỏ lỡ <br /><span class="text-red-600">mọi chuyển động</span>
        </h2>
        <p class="text-gray-400 text-xl md:text-2xl font-medium max-w-3xl mx-auto leading-relaxed">
          Đăng ký nhận bản tin để cập nhật sớm nhất các xu hướng xe máy, sự kiện ra mắt và ưu đãi
          độc quyền.
        </p>
        <div class="flex flex-wrap justify-center gap-6 pt-6">
          <NuxtLink
            to="/support"
            class="px-12 py-6 bg-red-600 text-white rounded-2xl font-black text-sm uppercase tracking-widest shadow-[0_25px_50px_-12px_rgba(230,0,35,0.6)] hover:scale-110 hover:-rotate-1 transition-all duration-500"
          >
            Đăng ký ngay
          </NuxtLink>
          <NuxtLink
