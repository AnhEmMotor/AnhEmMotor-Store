...
<template>
	<div
		v-if="aboutStore.aboutContent"
		class="about-page bg-white overflow-hidden"
	>
		<AboutHeroSection :data="aboutStore.aboutContent" class="reveal" />

		<AboutMissionSection
			:data="aboutStore.aboutContent.mission"
			class="reveal reveal-delay-1"
		/>

		<AboutServicesSection
			:data="aboutStore.aboutContent.services"
			class="reveal"
		/>
		...
		<AboutCommitmentSection
			:data="aboutStore.aboutContent.commitment"
			class="reveal"
		/>

		<AboutWhyChooseUsSection
			:data="aboutStore.aboutContent.whyChooseUs"
			class="reveal"
		/>

		<AboutContactSection
			:data="aboutStore.aboutContent.contact"
			class="reveal"
		/>
