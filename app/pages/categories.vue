    ...
    <div class="max-w-[1440px] mx-auto px-10">
      <div class="mb-16">
        ...
        <p class="text-gray-400 font-medium text-lg max-w-2xl">
          AnhEm Motor cung cấp đầy đủ các dòng xe máy, phụ tùng chính hãng và phụ kiện bảo hộ cao
          cấp nhất.
        </p>
      </div>
      ...
      <div
        ...
        class="text-center py-20 bg-gray-50 rounded-[3rem]"
      >
        ...
        <NuxtLink
          to="/"
          class="inline-block mt-8 px-8 py-3 bg-primary text-white font-black uppercase tracking-widest rounded-xl shadow-lg"
        >
          Quay về trang chủ
        </NuxtLink>
      </div>
