...
<template>
  <div class="bg-gray-50 min-h-screen pb-12">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      <h1
        class="text-3xl sm:text-5xl font-black text-gray-900 mb-8 uppercase tracking-tighter text-center"
      >
        BẢNG GIÁ XE MÁY
      </h1>
            ...
            <template v-for="product in products" :key="product.id">
              ...
              >
                <td
                  ...
                  class="px-6 py-6 border-r border-gray-200 align-middle"
                >
                  <div class="flex flex-col items-center gap-3">
                    <img
                      :src="product.image || '/assets/image/placeholder-product.webp'"
                      :alt="product.name"
                      class="w-32 h-auto object-contain mix-blend-multiply"
