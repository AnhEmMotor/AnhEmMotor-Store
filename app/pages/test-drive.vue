      ...
      <div class="container mx-auto px-6 relative z-10">
        <div class="max-w-2xl space-y-4">
          ...
          >
            ...
            <span class="text-[10px] font-extrabold text-white uppercase tracking-[0.3em]"
          ...
          >
            ĐẶT LỊCH<br /><span class="text-primary drop-shadow-[0_0_20px_rgba(227,24,55,0.5)]"
              >TRẢI NGHIỆM</span
            >
          </h1>
          <p
          ...
          <div class="lg:col-span-4 space-y-6 order-1">
            ...
            >
              ...
              >
                <div class="relative">
                  <img
                    :src="selectedVehicle.image || '/assets/image/placeholder-product.webp'"
                ...
                <div class="space-y-2 pt-2">
                  <div class="flex items-end justify-between">
                    ...
                    <p class="text-primary font-black text-[18px] leading-none">
              ...
              >
                ...
                <h3 class="text-[16px] font-extrabold text-gray-400 uppercase tracking-wide">
                  Chọn xe lái thử
                </h3>
                <p class="text-[10px] text-gray-400 px-8 leading-relaxed">
                  Vui lòng chọn dòng xe ở biểu mẫu bên cạnh để xem trước diện mạo & thông số.
                </p>
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div class="bg-gray-50 rounded-[20px] p-4 border border-gray-100 text-center">
                ...
                <p class="text-[10px] font-semibold text-gray-400 uppercase tracking-widest mt-1">
                  Độ hài lòng
                </p>
              </div>
            </div>
            ...
            <div class="bg-white rounded-[20px] shadow-xl border border-gray-100 overflow-hidden">
              <div class="p-6 lg:p-8 space-y-8">
                  ...
                  <div class="pt-2 space-y-4">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                      ...
                      >
                        ...
                        <span class="text-[9px] font-extrabold text-gray-900 uppercase">{{
                          trust.t
                        }}</span>
                      </div>
                    </div>
                ...
                <div v-else class="text-center py-8 space-y-4">
                  ...
                  <h2 class="text-[26px] font-extrabold uppercase">Thành công!</h2>
                  <NuxtLink
                    to="/products"
    ...
    <section class="py-12 bg-gray-50">
      <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div class="space-y-6">
            <h2 class="text-[28px] font-extrabold uppercase tracking-tight">
            ...
            <div class="grid grid-cols-1 gap-3">
              ...
              >
                ...
                <div class="space-y-1.5">
                  <h5 class="text-[15px] font-extrabold uppercase leading-tight tracking-tight">
                    {{ step.t }}
                  </h5>
