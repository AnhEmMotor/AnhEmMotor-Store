<template>
  <div class="recruitment-page bg-white overflow-hidden relative">
    ...
    <div class="fixed inset-0 pointer-events-none z-0">
      <div
        class="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-red-600/5 rounded-full blur-[120px] animate-pulse"
      />
      <div
        class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-red-600/5 rounded-full blur-[120px] animate-pulse delay-1000"
      />
    ...
    <main class="relative z-10">
      ...
      <div id="jobs" class="reveal reveal-up">
        <RecruitmentJobsList @apply-job="handleApplyJob" />
      </div>

      <div id="apply-form" class="reveal reveal-up">
        <RecruitmentApplicationForm :pre-selected-position="selectedPosition" />
      </div>

      <section class="py-20 bg-gray-50/50 relative overflow-hidden">
        <div
          class="absolute top-0 right-0 w-64 h-64 bg-primary/5 blur-[100px] rounded-full"
        />
        ...
        <div class="container mx-auto px-4 max-w-4xl relative z-10">
          <div class="text-center mb-16 reveal reveal-up">
            ...
            <p class="text-gray-500 font-medium text-sm max-w-xl mx-auto">
              Giải đáp nhanh những thắc mắc của ứng viên về quá trình tuyển dụng
              tại AnhEm Motor.
            </p>
          </div>
          ...
          <div class="space-y-6">
            ...
            >
              <div
                class="bg-white rounded-3xl border border-gray-100 transition-all hover:border-primary/20 hover:shadow-xl shadow-sm overflow-hidden group"
              >
                <button
                ...
                >
                  ...
                  >
                  <div
                    class="w-10 h-10 rounded-2xl bg-gray-50 flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all"
                  >
                    <Icon
      ...
      <section class="py-24 bg-[#0a0a0a] relative overflow-hidden text-center">
        <div class="absolute inset-0 z-0">
          <div
            class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/10 rounded-full blur-[150px] animate-pulse"
          />
        </div>
        ...
        <div class="container mx-auto px-4 relative z-10 reveal reveal-up">
          ...
          <p class="text-white/60 text-lg mb-12 max-w-2xl mx-auto font-medium">
            Chúng tôi không chỉ tìm kiếm nhân viên, chúng tôi tìm kiếm những
            cộng sự cùng chung lý tưởng và đam mê.
          </p>
          <button
  ...
  meta: [
    {
      name: "description",
      content:
        "Tìm kiếm cơ hội nghề nghiệp trong môi trường xe máy chuyên nghiệp, thân thiện tại AnhEm Motor. Tuyển dụng nhân viên bán hàng, kỹ thuật viên.",
    },
  ],
});
