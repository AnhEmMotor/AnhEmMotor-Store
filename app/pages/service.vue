...
useSeoMeta({
  ...
  description:
    'Bảo dưỡng, sửa chữa, thay lốp xe máy chính hãng tại AnhEm Motor. Quy trình chuyên nghiệp, giá cả minh bạch, bảo hành dài hạn.',
});
...
<template>
  <div class="bg-white min-h-screen text-gray-900 overflow-x-hidden">
    ...
    <ServiceFilterBar :active-category="activeCategory" @filter="handleFilter" />
