...
export const getBrandLogo = (brandName) => {
  ...
  if (name.includes('vinfast'))
    return 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Logo_of_VinFast_%283D%29.svg/3840px-Logo_of_VinFast_%283D%29.svg.png';
  if (name.includes('piaggio'))
    return 'https://inviva.vn/wp-content/uploads/2026/04/logo-piaggio-vector-06.png';
  if (name.includes('sym')) return 'https://icon2.cleanpng.com/20180506/irw/avsqu6kzz.webp';
  if (name.includes('ducati'))
    return 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Ducati_red_logo.svg/1920px-Ducati_red_logo.svg.png';
