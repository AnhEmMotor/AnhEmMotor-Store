...
export const usePermissions = () => {
  ...
  const PERMISSION_METADATA = computed(() => permissionConfig.value?.metadata || {});
  const PERMISSION_GROUPS = computed(() => permissionConfig.value?.groups || []);
  ...
  return {
    ...
    getPermissionDescription: (key) => PERMISSION_METADATA.value[key]?.description || '',
