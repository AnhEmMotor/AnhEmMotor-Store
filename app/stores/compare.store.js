...
export const useCompareStore = defineStore("compare", () => {
	...
	const addProduct = (product) => {
		...
		if (lockedType.value && lockedType.value !== "Khác" && newType !== "Khác" && newType !== lockedType.value) {
			return { success: false, error: `Vui lòng chọn xe cùng loại (${lockedType.value}) để so sánh!` };
		}
